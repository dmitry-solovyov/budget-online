...
public System.Web.WebPages.HelperResult Render(SelectItemsModel model, string propertyName, string cssClass, bool multiSelect, IDictionary<string, object> additionalValues)
    {
...
WriteLiteralTo(@__razor_helper_writer, "    <select class=\"form-control ");
...
WriteTo(@__razor_helper_writer, new HtmlString(model.Required ? "required='required'" : string.Empty));
...
#line 38 "..\..\Views\Editors\SelectList.cshtml"
        }
...
#line 41 "..\..\Views\Editors\SelectList.cshtml"
