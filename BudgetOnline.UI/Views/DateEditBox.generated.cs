...
WriteLiteralTo(@__razor_helper_writer, "    <div class=\"input-append ");



#line 11 "..\..\Views\DateEditBox.cshtml"
WriteTo(@__razor_helper_writer, model.Span > 0 ? "span" + model.Span.ToString(CultureInfo.InvariantCulture) : string.Empty);
...
WriteLiteralTo(@__razor_helper_writer, "\" class=\"date-picker input-block-level\" autocomplete=\"off\"/>\r\n        <span class" +
"=\"add-on\"><i class=\"icon-calendar\"></i></span>\r\n    </div>\r\n");
