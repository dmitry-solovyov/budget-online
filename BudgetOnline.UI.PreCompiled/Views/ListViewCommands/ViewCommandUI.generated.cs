...
WriteAttributeTo(__razor_helper_writer, "class", Tuple.Create(" class=\"", 414), Tuple.Create("\"", 458)
, Tuple.Create(Tuple.Create("", 422), Tuple.Create("dropdown", 422), true)

#line 16 "..\..\Views\ListViewCommands\ViewCommandUI.cshtml"
, Tuple.Create(Tuple.Create("", 430), Tuple.Create<System.Object, System.Int32>(!isRoot ? "-submenu" : ""
...
WriteTo(__razor_helper_writer, new _Page_Views_ListViewCommands_ViewCommandUI_cshtml().Render(childItem, false));
...
#line 32 "..\..\Views\ListViewCommands\ViewCommandUI.cshtml"
          WriteTo(__razor_helper_writer, new _Page_Views_ListViewCommands_PostViewCommand_cshtml().Render(command));
...
#line 36 "..\..\Views\ListViewCommands\ViewCommandUI.cshtml"
          WriteTo(__razor_helper_writer, new _Page_Views_ListViewCommands_RedirectViewCommand_cshtml().Render(command));
...
#line 40 "..\..\Views\ListViewCommands\ViewCommandUI.cshtml"
          WriteTo(__razor_helper_writer, new _Page_Views_ListViewCommands_JsViewCommand_cshtml().Render(command));
