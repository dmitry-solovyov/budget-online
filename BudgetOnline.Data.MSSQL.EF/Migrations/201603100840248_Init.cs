namespace BudgetOnline.Data.MSSQL.EF.Migrations
{
    ...
    public partial class Init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ValidTo = c.DateTime(),
                        SecretQuestion = c.String(maxLength: 1024),
                        SecretQuestionAnswer = c.String(maxLength: 1024),
                ...
                c => new
                    {
                        ...
                        CreatedWhen = c.DateTime(nullable: false, precision: 7, storeType: "datetime2"),
                        ExpiresWhen = c.DateTime(nullable: false, precision: 7, storeType: "datetime2"),
                        RowVersion = c.Binary(nullable: false, fixedLength: true, timestamp: true, storeType: "rowversion"),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Users", t => t.UserId)
                .ForeignKey("dbo.UserPasswords", t => t.UserPasswordId)
                .ForeignKey("dbo.UserSessionStatuses", t => t.UserSessionStatusId)
        ...
        {
            DropForeignKey("dbo.UserSessions", "UserSessionStatusId", "dbo.UserSessionStatuses");
            ...
            DropTable("dbo.UserSessionStatuses");
