...
{
    [Table("TransactionCorrectionDetails")]
    public class TransactionCorrectionDetailRecord : GuidIdentifiedBaseModel, ICreateTrakingModel, ILastUpdateTrakingModel
    {
        ...
        public virtual TransactionDetailRecord TransactionDetail { get; set; }
